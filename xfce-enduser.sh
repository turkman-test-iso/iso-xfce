...
ymp it @xfce4 xfce4-screenshooter xfce4-battery-plugin xfce-polkit xfce4-pulseaudio-plugin xfce4-terminal xfce4-whiskermenu-plugin mousepad ristretto --no-emerge --allow-oem
